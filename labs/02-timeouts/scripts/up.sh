...
wait_for_service localhost 8474 "Toxiproxy API" 60
wait_for_service localhost 8666 "Toxiproxy mock LLM proxy" 60
...
log_info "Lab 2 is running with the before implementation."
