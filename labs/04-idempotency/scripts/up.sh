#!/usr/bin/env bash
# Start all services for the idempotency lab.
...
log_info "Starting Lab 4: Idempotency"
check_docker
...
log_info "Lab 4 is running with the before implementation."
log_info "API: http://localhost:8080"
log_info "Mock LLM: http://localhost:8888"
